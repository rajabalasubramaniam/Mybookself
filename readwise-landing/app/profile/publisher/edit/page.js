...
export default function PublisherEditProfile() {
    ...
    useEffect(() => {
        async function loadProfile() {
            try {
                ...
                setCompanyName(publisher?.company_name || '');
        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="max-w-2xl mx-auto px-4">
                <div className="bg-white rounded-xl shadow p-8">
                    <h1 className="text-3xl font-bold text-blue-900 mb-8">Edit Publisher Profile</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-gray-700 mb-2">Your Name (Contact Person)</label>
                            <input
                                type="text"
                                value={fullName}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-900"
                                rows="4"
                                placeholder="About your publishing house..."
                            />
                        </div>
                        <div>
