...
export default function ReaderEditProfile() {
    ...
    useEffect(() => {
        async function loadProfile() {
            try {
                ...
                // Optionally check role – redirect if not reader
                ...
                if (profile?.role !== 'reader') {
                    router.push('/dashboard'); // or to the correct edit page
                    return;
                }
                ...
                setReadingGoal(profileData.reading_goal || 12);
            } catch (err) {
        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="max-w-2xl mx-auto px-4">
                <div className="bg-white rounded-xl shadow p-8">
                    <h1 className="text-3xl font-bold text-blue-900 mb-8">Edit Reader Profile</h1>
